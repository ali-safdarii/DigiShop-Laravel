...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->foreignId('coupons_id')->nullable()->constrained('copans')->onUpdate('cascade')->onDelete('cascade');
            $table->longText('coupons_object')->nullable();
            $table->decimal('order_coupons_discount_amount',20, 3)->nullable();
