...
@section('content')
    ...
    <div class="main-content ">
        <form class="needs-validation" action="{{route('market.brand.store')}}" method="post"
            ...
            <div
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 p-3">
                    ...
                    <div class="form-content">
                        ...
                        <div class="form-input">
                            <label class="form-label bottom-element" for="persian_name">Persian</label>
                            <input type="text" id="persian_name" name="persian_name" class="form-control"/>
                        </div>
                        ...
                        {{-- <div class="container p-2" id="tags-container"></div>--}}
