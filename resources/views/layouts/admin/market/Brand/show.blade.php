...
@section('content')
    ...
    <div class="main-content ">
        ...
        <x-custom-component.delete-modal :message="'brands?'"
                                         :route=" route('market.brand.destroy', ['brand' => $brand->id]) "
        />


        <form id="brand-form" class="needs-validation"
              action="{{route('market.brand.update',$brand->id)}}" method="post"
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 p-3">
                    ...
                    <div class="form-content">
                        <div class="form-input has-validation">
                            ...
                            <input type="text" value="{{$brand->name}}" id="name" name="name"
                        ...
                        <div class="form-content ">
                            ...
                            <div class="form-input">
                                <label class="bottom-element form-label" for="persian_name">PersianName</label>
                                <input type="text" value="{{$brand->persian_name}}" id="persian_name"
                                       name="persian_name"
                                       class="form-control"/>
                            </div>
                            ...
                            <div class="form-input">
                                ...
                                <label class="bottom-element  form-label" for="tags-input">Tags</label>
                            ...
                            <div type="hidden" style="display:none;" class="form-input">
                                ...
                                <input class="form-control" type="text" id="tags-hidden-input"
                                       name="tags[]"
                                       value="{{ implode(', ', $brand->tags->pluck('name')->toArray()) }}"/>
                            </div>
