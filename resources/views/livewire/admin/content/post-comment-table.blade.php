<div class="shadow-3 card mt-5 p-3">
    ...
    <div class="d-flex justify-content-between m-3 p-3 border-bottom">
        ...
        <a href="#">
            <button class="btn btn-primary disabled">Create
                <i class="fas ms-1 fa-add"></i>
            </button>
        </a>
        <h5 wire:loading.remove>Comments ({{\App\Models\Admin\Content\Comment::count()}})</h5>
        ...
        <table class="table-responsive table">
            ...
            @forelse($comments as $comment)
                <tr>
                    ...
                    <th scope="row">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{ $comment->id }}"
                                   id="checkbox-{{ $comment->id }}" wire:model="selectedItems">
                    ...
                    <td>
                        {{\App\Utili\Helper::limitStr($comment->commentable->title)}}
                    </td>
                    ...
                    <td>
                        ...
                        <label>
                            <input class="form-check-input" type="checkbox" wire:model="isActive.{{ $comment->id }}" wire:click="toggleActivation({{ $comment->id }})" />
                        </label>

                    </td>

                    <td>
                        <a class="btn btn-primary" type="submit" href="{{route('content.comment.show',$comment)}}"
                           role="button">
                            show
            ...
            @empty
                ...
                <tr class="font-weight-normal ">
                    <td colspan="10"><span>not any comment found.</span></td>
                </tr>
