<div class="shadow-3 card mt-5 p-3">
    ...
    <div class="d-flex justify-content-between m-3 p-3 border-bottom">
        ...
        <h5 wire:loading.remove>Comment ({{\App\Models\Admin\Content\Comment::count()}})</h5>
        ...
        <table class="table-responsive table">
            ...
            @forelse($comments as $comment)
                <tr>
                    ...
                    <td>
                        {{\App\Utili\Helper::limitStr($comment->commentable->name)}}
                    </td>
                    ...
                    <td>
                        <a class="btn btn-primary" type="submit" href="{{route('market.comments.show',$comment)}}"
                           role="button">
                            show
