<div class="shadow-3 card mt-5 p-3">
    ...
    <div class="d-flex justify-content-between m-3 p-3 border-bottom">
        ...
        <a href="{{route('market.attributes.value.create',$attribute->id)}}">
            <button class="btn btn-primary">Create
                <i class="fas ms-1 fa-add"></i>
            </button>
        </a>

        <h5 wire:loading.remove>Values ({{\App\Models\Admin\Market\CategoryValue::count()}})</h5>
        ...
        <table class="table-responsive table">
            ...
            @forelse($values as $value)
                <tr>
                    ...
                    <th scope="row">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{ $value->id }}"
                                   id="checkbox-{{ $value->id }}" wire:model="selectedItems">
                    ...
                    <td>
                        {{\App\Utili\Helper::limitStr($attribute->name)}}
                    </td>
                    ...
                    <td>
                        {{json_decode($value->value)->price_inc ?? ''}}
                    </td>

                    <td>
                        <a class="btn btn-primary" type="submit"
                           href="{{route('market.attributes.value.show', ['attribute' => $attribute->id, 'value' => $value])}}"
                           role="button">
                            show
            ...
            @empty
                ...
                <tr class="font-weight-normal ">
                    <td colspan="10"><span>not any values found.</span></td>
                </tr>
